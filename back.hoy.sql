...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '3c94a7c2-fd18-11f0-a25d-f6a0e294a7be:1-213';
...
INSERT INTO `Estacionamiento` VALUES (1,'mi casa','calle falsa 333','','',4,1),(2,'estacionamiento 2','liropeya 123','','',4,1),(3,'Agustin parking','18 de julio y tu vieja','','',4,1),(4,'estacionamiento nuevo2','18 de julio y ejido','','',5,1),(5,'la casa de carlos','casa de carlos','','',5,1),(6,'parking test','calle test 123','','',4,1),(7,'parking test','calle test 123','','',4,1),(8,'parking test','calle test 123','','',4,1),(9,'parking test','calle test 123','','',4,1),(10,'parking test','calle test 123','','',4,1),(11,'parking test','calle test 123','','',4,1),(12,'parking test','calle test 123','','',4,1),(13,'parking test','calle test 123','','',4,1),(14,'parking test','calle test 123','','',4,1),(15,'parking test','calle test 123','','',4,1),(16,'parking test','calle test 123','','',4,1),(17,'parking test','calle test 123','','',4,1),(18,'parking test','calle test 123','','',4,1),(19,'parking test','calle test 123','','',4,1),(20,'parking test','calle test 123','','',4,1),(21,'parking test','calle test 123','','',4,1),(22,'parking test','calle test 123','','',4,1),(23,'parking test','calle test 123','','',4,1),(24,'parking test','calle test 123','','',4,1),(25,'parking test','calle test 123','','',4,1),(26,'parking test','calle test 123','','',4,1),(27,'parking test','calle test 123','','',4,1);
...
INSERT INTO `Piso` VALUES (1,1,4,'este ahora es ese',1,0),(2,1,3,'ah este si es el bueno',1,0),(3,2,1,'sada',1,0),(4,4,1,'piso normal',1,0),(5,4,1,'piso 1',1,0),(6,4,1,'Este piso',1,0),(7,3,1,'esta casa',1,0),(8,5,1,'planta baja',1,0),(9,1,1,'Piso test',1,0),(10,1,1,'Piso test',1,0),(11,1,1,'Piso test',1,0),(12,1,1,'Piso test',1,0),(13,1,1,'Piso test',1,0),(14,1,1,'Piso test',1,0),(15,16,1,'Piso test',1,0),(16,17,1,'Piso test',1,0),(17,18,1,'Piso test',1,0),(18,19,1,'Piso test',1,0),(19,20,1,'Piso test',1,0),(20,21,1,'Piso test',1,0),(21,22,1,'Piso test',1,0),(22,23,1,'Piso test',1,0),(23,24,1,'Piso test',1,0),(24,25,1,'Piso test',1,0),(25,26,1,'Piso test',1,0),(26,27,1,'Piso test',1,0);
...
CREATE TABLE `Reserva` (
  ...
  `patente_manual` varchar(20) DEFAULT NULL,
  `origen_reserva` enum('cliente','admin') DEFAULT 'cliente',
  PRIMARY KEY (`reserva_id`),
  KEY `lugar_id` (`lugar_id`),
  KEY `usuario_id` (`usuario_id`),
  KEY `fk_reserva_vehiculo` (`vehiculo_id`),
  CONSTRAINT `fk_reserva_vehiculo` FOREIGN KEY (`vehiculo_id`) REFERENCES `Vehiculo` (`vehiculo_id`),
...
CREATE TABLE `Vehiculo` (
  ...
  KEY `fk_usuario_vehiculo` (`usuario_id`),
  CONSTRAINT `fk_usuario_vehiculo` FOREIGN KEY (`usuario_id`) REFERENCES `Usuario` (`usuario_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-09-07 12:51:54
